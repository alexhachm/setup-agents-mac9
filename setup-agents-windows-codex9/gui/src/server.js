...
if (!fs.existsSync(stateDir)) {
    console.error('❌ Error: .codex-shared-state directory not found');
...
// File paths
const getStatePath = (file) => path.join(projectPath, '.codex-shared-state', file);
const getLogPath = () => path.join(projectPath, '.codex', 'logs', 'activity.log');
